...
public class DummyDatabaseCard {
    ...
    DummyDatabaseCard() {
        ...
        events.add(new Event(1, "Qwerty 1", "Place 1", "Description 1", url1, "Красноярск", "Выставки", false, false));
        events.add(new Event(2, "Event 2", "Place 2", "Description 2", url2, "Красноярск", "Выставки", false, false));
        events.add(new Event(3, "Event 3", "Place 3", "Description 3", url1, "Новосибирск", "Выставки", true, false));
        events.add(new Event(4, "Event 4", "Place 4", "Description 4", url2, "Новосибирск", "Концерты", true, false));
    }
