...
public class DummyDatabaseCard {
    ...
    DummyDatabaseCard() {
        ...
        cards.add(new Card(1, "Qwerty 1", "Place 1", "Description 1", url1, false));
        cards.add(new Card(2, "Event 2", "Place 2", "Description 2", url2, false));
        cards.add(new Card(3, "Event 3", "Place 3", "Description 3", url1, true));
        cards.add(new Card(4, "Event 4", "Place 4", "Description 4", url2, true));
    }
